...
public:
	FastlioOdometryGuard() : Node("fastlio_odometry_guard")
	{
		...
		max_computed_z_speed_mps_ = declare_parameter<double>("max_computed_z_speed_mps", 0.7);
...
private:
	...
	double max_computed_z_speed_mps_{0.7};
	...
	bool passes_motion_gate(const Odometry &msg, std::string &reason)
	{
