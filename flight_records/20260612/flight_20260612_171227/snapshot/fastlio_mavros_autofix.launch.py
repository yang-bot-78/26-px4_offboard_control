...
def generate_launch_description():
        ...
        parameters=[
            {
                ...
                "max_dt_s": 1.0,
                "max_position_jump_m": 0.60,
                "max_xy_jump_m": 0.45,
                "max_z_jump_m": 0.25,
                "max_computed_speed_mps": 3.0,
                "max_computed_z_speed_mps": 1.5,
            }
        ],
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("vision_yaw_offset_rad", default_value="3.141592653589793"),
            DeclareLaunchArgument("vision_position_yaw_offset_rad", default_value="3.141592653589793"),
