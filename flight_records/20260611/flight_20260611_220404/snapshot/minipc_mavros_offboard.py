...
class MiniPcMavrosOffboard(Node):
    def __init__(self) -> None:
        ...
        self.get_logger().info(
            ...
            f"recent_pose_samples={self.recent_pose_samples}, lift_only_seconds={self.lift_only_seconds}, "
    ...
    def _estimate_ready(self) -> bool:
        ...
        return all(math.isfinite(v) for v in (p.x, p.y, p.z)) and len(self._odom_samples) >= 5
